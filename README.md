...
## Usage
Make sure all of your classes are already in your SIS cart before using. Then run the following command in Command Prompt/Terminal on registration day at least 3 minute (ideally 5 minutes) before 7:00 AM on registration day
